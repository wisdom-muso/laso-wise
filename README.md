...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-org/lasohealthcare.git
   cd lasohealthcare
   ```
...
5. **Database setup:**
   ...
   python manage.py setup_lasohealthcare --all
   ```
...
```bash
# Database
DATABASE_URL=postgresql://user:pass@localhost/lasohealthcare
...
python manage.py setup_lasohealthcare --sample-data
...
- 📚 [Full Documentation](https://docs.lasohealthcare.com)
- 🐛 [Issue Tracker](https://github.com/your-org/lasohealthcare/issues)
- 💬 [Community Forum](https://community.lasohealthcare.com)
- 📧 [Email Support](mailto:support@lasohealthcare.com)
...
For more information, visit [www.lasohealthcare.com](https://www.lasohealthcare.com)
|------|-------------|
